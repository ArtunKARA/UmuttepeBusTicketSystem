  ...
  function initMap() {
    ...
    var map = new google.maps.Map(document.getElementById('map'), {
      ...
      center: {
        lat: 41.0082,
        lng: 28.9784
      } // İstanbul koordinatları, başlangıç noktası olarak kullanılabilir.
    });
    ...
    <div class="selectroom_top">
      <div class="col-md-12 selectroom_right wow fadeInRight animated" data-wow-delay=".5s">
        <ul>
          ...
          <li>
            <h6> <?php echo $sefer["OtobusIsim"] ?> </h6> <?php 
...
?>
        ...
        <div class="selectroom_top">
          <div class="set-left">
            ...
            for ($i = 1; $i <= 32/2; $i++) {
                echo "
									<li>
										<input type='checkbox' class='koltuk bos' data-koltuk-no='$i'>$i
										</li>";
            }
            ?> <div class="clearfix"></div>
            </ul>
          ...
          <div style="margin-top: 2%; display: flex; justify-content: center;">
            ...
            <form method="post" action="
											<?php echo Base_url('UmuttepeBusTicketSystem/ciapp/public/kullaniciBilgi'); ?>">
  ...
  <div id="cinsiyetSecimPopup" class="cinsiyet-popup" style="display: none; position: absolute;">
    <form id="cinsiyetForm">
      <label>
        <input type="radio" name="cinsiyet" value="kiz"> Kız </label>
      <label>
        <input type="radio" name="cinsiyet" value="erkek"> Erkek </label>
